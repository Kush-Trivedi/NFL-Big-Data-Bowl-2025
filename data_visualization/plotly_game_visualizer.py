...
class PlotlyGameVisualizer:
    ...
    def plot_game_in_plotly(self, gameId, playId):
        ...
        for playId in temp_tracking_df['playId'].dropna().unique():
            ...
            temp_tracking_df = (self.df[temp_tracking_query][['x', 'y','frameId', 'nflId', 'Team', 'displayName','playDescription','jerseyNumber','absoluteYardlineNumber','yardsToGo','down','playDirection','position',]].fillna("").sort_values(['frameId']))
